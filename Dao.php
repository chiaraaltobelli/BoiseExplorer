...
require_once __DIR__ . '/libs/vendor/klogger/src/Logger.php';
...
class Dao {
    ...
    public function getConnection() {
        try {
            return new PDO("mysql:host={$this->host};dbname={$this->db}", $this->user, $this->pass, array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
